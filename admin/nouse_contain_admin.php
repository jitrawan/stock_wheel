      ...
      <div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
                                ...
                                <form name="add_profile" action="" method="post" enctype="multipart/form-data" onsubmit="">
								<div>
								...
								<div id="user-profile-1" class="user-profile row">
										<div class="col-xs-12 col-sm-3 center">
                                           ...
                                           <!-- <img id="imgAvatar" width="300">-->
												...
												<span class="ace-file-container" data-title="Choose"><span class="ace-file-name" data-title="No File ..."></span><input type="file" id="input-dim-1" accept="image/*" name="applicant_files" onchange="" required></span>
										...
										<div class="col-xs-12 col-sm-9">
											...
											<div class="profile-user-info profile-user-info-striped">
                                            	<div class="profile-info-row">
													...
													<div class="profile-info-value">
                                                    	<input type="text" name="icard" class="col-xs-5 col-sm-5" placeholder="เลขที่บัตรประชาชน" maxlength="13" onkeypress="" required>
													</div>
												</div>
												<div class="profile-info-row">
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
                                                        ...
                                                        <select id="provinces" name="provinces" required="" onchange="">
                                                      ...
                                                      <select name="amphures" id="amphures" onchange="">
                                                            <option value="">--เลือกอำเภอ--</option>
                                                      </select>
                                                      <select name="districts" id="districts" required="" onchange="">
                                                ...
                                                <div class="profile-info-row">
													<div class="profile-info-name"> ที่อยู่ปัจจุบัน </div>

													<div class="profile-info-value">
                                                    
                                                    	<input name="type_add" type="radio" value="Y" onclick="" required> ที่อยู่ตามทะเบียนบ้าน
                                                        <input name="type_add" type="radio" value="N" onclick="" required> ที่อยู่ใหม่
                                                        <div style="display:none;" id="showAdd1">
                                                        <div style="height:10px;"></div>
                                                    	<textarea name="address2" class="col-xs-12 col-sm-12"></textarea>
                                                        <div style="height:60px;"></div>
                                                        
                                                        <select id="provinces2" name="provinces2" onchange="">
                                                          <option selected="" value="">--เลือกจังหวัด--</option>
                                                                                                                    <option value="64">กระบี่   </option>
                                                                                                                    <option value="1">กรุงเทพมหานคร   </option>
                                                                                                                    <option value="56">กาญจนบุรี   </option>
                                                      ...
                                                      <select name="amphures2" id="amphures2" onchange="">
                                                            <option value="">--เลือกอำเภอ--</option>
                                                      </select>
                                                      <select name="districts2" id="districts2" onchange="">
                                                            <option value="">--เลือกตำบล--</option>
                                                      </select>
                                                       <select name="zipcodes2" id="zipcodes2">
                                                            <option value="">--รหัสไปรษณีย์--</option>
                                                      </select>
                                                      </div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
                                                    	<input type="text" name="mobile" class="col-xs-5 col-sm-5" placeholder="เบอร์โทรศัพท์" onkeypress="" maxlength="10" required>
													</div>
												</div>
                                                ...
                                                <div class="profile-info-row">
													...
													<div class="profile-info-value">
                                                    	<input type="text" name="contact" placeholder="บุคคลอ้างอิง" class="col-xs-5 col-sm-5" onkeyup="" required>
                                                        <input type="text" name="contact_link" placeholder="สถานะภาพ" class="col-xs-5 col-sm-5" onkeyup="" required>
													</div>
												</div>
                                                ...
                                                <div class="profile-info-row">
													...
													<div class="profile-info-value">
                                                    	<input type="text" name="contact_mobile" placeholder="เบอร์บุคคลอ้างอิง" onkeypress="" maxlength="10" class="col-xs-5 col-sm-5" required>
													</div>
												</div>
                                                ...
                                                <div class="profile-info-row">
													...
													<div class="profile-info-value">
                                                    	<input type="password" name="pass" placeholder="รหัสผ่าน" class="col-xs-5 col-sm-5" value="123456" readonly>
													</div>
												</div>
                                            ...
                                            <a href="#"><button class="btn btn-danger" type="button" onclick="window.history.back();">
